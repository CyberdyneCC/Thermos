...
public final class BlockUpdatesTracker implements Iterable<BlockUpdateEntry> {
    ...
    public final HashSet<NextTickListEntry> linkedHashSet = new VanillaLinkedHashSetWrapper();
    ...
    private final class VanillaLinkedHashSetWrapper extends LinkedHashSet<NextTickListEntry> {
        @Override
